...
// Popular battles from page.tsx (manually copied for verification)
const POPULAR_BATTLES = [
    { a: 'white-rice', b: 'brown-rice' },
    { a: 'chicken-breast-skinless', b: 'beef-rib' },
    { a: 'banana', b: 'apple' },
    { a: 'broccoli', b: 'tomato' },
    { a: 'chicken-thigh-skin', b: 'white-rice' },
...
POPULAR_BATTLES.forEach(battle => {
    if (!foodIds.has(battle.a)) console.log(`Missing A: ${battle.a}`);
    if (!foodIds.has(battle.b)) console.log(`Missing B: ${battle.b}`);
});
